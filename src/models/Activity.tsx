...
ActivitySchema.index({ userId: 1, status: 1 }); // Optimizes Activity.aggregate for stats
ActivitySchema.index({ userId: 1, createdAt: -1 }); // Optimizes Activity.find().sort() for recent history
